 ...
 *
 * They mirror targeting.spec.ts exactly but use { workers: true } to exercise
 * the interpreter code path and prove it avoids dynamic code generation.
 */
...
describe('targeting (workers mode)', () => {
  beforeEach(() => {
    jest.resetAllMocks();
  });
  ...
  describe('Context injection', () => {
    it('should inject flag key as a property', () => {
      ...
      const targeting = new Targeting(logic, logger, { workers: true });
