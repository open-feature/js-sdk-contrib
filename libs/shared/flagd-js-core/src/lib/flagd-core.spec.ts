...
import {ErrorCode, GeneralError, StandardResolutionReasons, TypeMismatchError} from '@openfeature/server-sdk';
...
describe('flagdJsCore validations', () => {
  ...
  it('should validate flag status', () => {
    expect(() => core.resolveStringEvaluation('myBoolFlag', 'false', {}))
