...
import type { LDLogger, LDOptions, LDStartOptions } from '@launchdarkly/js-client-sdk';
 ...
 */
export interface LaunchDarklyProviderOptions extends LDOptions, LDStartOptions {
  /**
